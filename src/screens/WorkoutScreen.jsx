...
function LiveSession({ deviceName, onEndSession, onExpand }) {
  ...
  return (
    <motion.div
      ...
      style={{ width:370, borderRadius:8,
      ...
      <div style={{ display:'flex', alignItems:'center', gap:8, padding:'0 12px 8px' }}>
        {/* Metric cell 1: HR */}
        <div style={{ width:143, height:44, background:'rgba(255,255,255,0.04)',
...
export default function WorkoutScreen({ device, onFinish, onConnectNew }) {
  ...
  return (
    <div style={{ width:'100%', height:'100%', position:'relative',
      ...
      {/* ── HEADER 180px ─────────────────────────────── */}
      <div style={{ position:'absolute', top:54, left:0, right:0, height:180,
        ...
        <div style={{ position:'absolute', top:16, left:16, width:370, height:112 }}>
          ...
          <div style={{ position:'absolute', bottom:0, left:0, right:0,
            ...
            {[
              { label:'HR',       value:`${globalHr}`, unit:'bpm', color:'#ef4444', w:113, align:'flex-start' },
              { label:'Calories', value:`${String(globalCal).padStart(3,'0')}`, unit:'kcal', color:'#fff', w:113, align:'center' },
              { label:'Time',     value:fmt(totalTime), unit:'', color:'#fff', w:113, align:'flex-end' },
            ].map((m,i) => (
